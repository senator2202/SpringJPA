...
-- Дамп данных таблицы world.city: ~4 188 rows (приблизительно)
...
-- Дамп данных таблицы world.country: ~239 rows (приблизительно)
...
-- Дамп структуры для таблица world.countrylanguage
...
-- Дамп данных таблицы world.countrylanguage: ~984 rows (приблизительно)
